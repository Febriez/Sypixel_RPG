    ...
    private static Builder createBuilder() {
        return new ShadowInvasionBuilder()
                ...
                .objectives(Arrays.asList(
                        // 침략 발견
                        new InteractNPCObjective("scout_report", 121), // 정찰병
                        ...
                        // 방어 준비
                        new InteractNPCObjective("commander_talk", 122), // 방어 사령관
                        ...
                        new InteractNPCObjective("shadow_general_talk", 123), // 그림자 장군
                        ...
                        new InteractNPCObjective("victory_ceremony", 122)
                ))
                ...
                .prerequisiteQuests(Arrays.asList(QuestID.MAIN_GUARDIAN_AWAKENING))
                .minLevel(35)
                .maxLevel(0);
    }
