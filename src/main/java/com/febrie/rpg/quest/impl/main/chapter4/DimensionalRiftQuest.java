...
public class DimensionalRiftQuest extends Quest {
     ...
     * 퀘스트 빌더
     */
    private static class DimensionalRiftBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new DimensionalRiftQuest(this);
        }
    }
     ...
     * 빌더 생성자
     */
    private DimensionalRiftQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    private static QuestBuilder createBuilder() {
        return new DimensionalRiftBuilder()
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.dimensional_rift.name");
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        ...
        return Component.translatable("quest.main.dimensional_rift.objectives." + id);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.dimensional-rift.dialogs.0");
            case 1 -> Component.translatable("quest.main.dimensional-rift.dialogs.1");
            case 2 -> Component.translatable("quest.main.dimensional-rift.dialogs.2");
            case 3 -> Component.translatable("quest.main.dimensional-rift.dialogs.3");
            case 4 -> Component.translatable("quest.main.dimensional-rift.dialogs.4");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.dimensional-rift.npc-name");
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.dimensional-rift.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.dimensional-rift.decline");
    }
}