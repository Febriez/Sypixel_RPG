    ...
    private static Builder createBuilder() {
        return new MageEnlightenmentBuilder()
                ...
                .objectives(Arrays.asList(
                        // 마법사의 길 시작
                        new InteractNPCObjective("archmage_mentor", 210), // 대마법사 스승
                        ...
                        new InteractNPCObjective("knowledge_keeper", 215), // 지식의 수호자
                        ...
                        new InteractNPCObjective("rival_mage", 216), // 라이벌 마법사
                        ...
                        new InteractNPCObjective("graduation_ceremony", 210)
                ))
