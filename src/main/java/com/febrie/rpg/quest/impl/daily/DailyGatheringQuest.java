...
public class DailyGatheringQuest extends Quest {
    ...
    private static QuestBuilder createBuilder() {
        return new DailyGatheringBuilder().id(QuestID.DAILY_GATHERING).objectives(Arrays.asList(
                        // 기본 자원 수집
    ...
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        return Arrays.asList(Component.translatable("quest.daily.gathering.description[0]"), Component.translatable("quest.daily.gathering.description[1]"), Component.translatable("quest.daily.gathering.description[2]"), Component.translatable("quest.daily.gathering.description[3]"));
    }
