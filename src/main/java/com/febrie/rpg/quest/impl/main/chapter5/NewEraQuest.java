...
public class NewEraQuest extends Quest {
     ...
     * Quest builder
     */
    private static class NewEraBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new NewEraQuest(this);
        }
    }
     ...
     * Builder constructor
     */
    private NewEraQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.new-era.name");
    }
    ...
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        ...
        for (int i = 0; i < 3; i++) {
            description.add(Component.translatable("quest.main.new-era.description." + i));
        }
        return description;
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        return Component.translatable("quest.main.new-era.objectives." + objective.getId());
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.new-era.dialogs.0");
            case 1 -> Component.translatable("quest.main.new-era.dialogs.1");
            case 2 -> Component.translatable("quest.main.new-era.dialogs.2");
            case 3 -> Component.translatable("quest.main.new-era.dialogs.3");
            case 4 -> Component.translatable("quest.main.new-era.dialogs.4");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.new-era.npc-name");
    }
    
    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.new-era.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.new-era.decline");
    }
}