...
public class DailyExplorationQuest extends Quest {
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return LangManager.get("quest.daily.exploration.name", who);
    }

    @Override
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        return LangManager.getList("quest.daily.exploration.info", who);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> LangManager.get("quest.daily.exploration.dialogs.0", who);
            case 1 -> LangManager.get("quest.daily.exploration.dialogs.1", who);
            case 2 -> LangManager.get("quest.daily.exploration.dialogs.2", who);
            case 3 -> LangManager.get("quest.daily.exploration.dialogs.3", who);
            case 4 -> LangManager.get("quest.daily.exploration.dialogs.4", who);
            case 5 -> LangManager.get("quest.daily.exploration.dialogs.5", who);
            case 6 -> LangManager.get("quest.daily.exploration.dialogs.6", who);
            case 7 -> LangManager.get("quest.daily.exploration.dialogs.7", who);
            case 8 -> LangManager.get("quest.daily.exploration.dialogs.8", who);
            case 9 -> LangManager.get("quest.daily.exploration.dialogs.9", who);
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return LangManager.get("quest.daily.exploration.npc_name", who);
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return LangManager.get("quest.daily.exploration.accept", who);
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return LangManager.get("quest.daily.exploration.decline", who);
    }
}