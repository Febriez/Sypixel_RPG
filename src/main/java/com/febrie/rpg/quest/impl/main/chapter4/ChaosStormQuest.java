...
public class ChaosStormQuest extends Quest {
     ...
     * 퀘스트 빌더
     */
    private static class ChaosStormBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new ChaosStormQuest(this);
        }
    }
     ...
     * 빌더 생성자
     */
    private ChaosStormQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.chaos_storm.name");
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        ...
        return Component.translatable("quest.main.chaos_storm.objectives." + id);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.chaos-storm.dialogs.0");
            case 1 -> Component.translatable("quest.main.chaos-storm.dialogs.1");
            case 2 -> Component.translatable("quest.main.chaos-storm.dialogs.2");
            case 3 -> Component.translatable("quest.main.chaos-storm.dialogs.3");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.chaos-storm.npc-name");
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.chaos-storm.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.chaos-storm.decline");
    }
}