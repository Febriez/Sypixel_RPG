...
public class HeroesAllianceQuest extends Quest {
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return LangManager.get("quest.main.heroes_alliance.name", who);
    }
    
    @Override
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        return LangManager.getList("quest.main.heroes_alliance.info", who);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> LangManager.get("quest.main.heroes_alliance.dialogs.0", who);
            case 1 -> LangManager.get("quest.main.heroes_alliance.dialogs.1", who);
            case 2 -> LangManager.get("quest.main.heroes_alliance.dialogs.2", who);
            case 3 -> LangManager.get("quest.main.heroes_alliance.dialogs.3", who);
            case 4 -> LangManager.get("quest.main.heroes_alliance.dialogs.4", who);
            case 5 -> LangManager.get("quest.main.heroes_alliance.dialogs.5", who);
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return LangManager.get("quest.main.heroes_alliance.npc_name", who);
    }
    
    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return LangManager.get("quest.main.heroes_alliance.accept", who);
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return LangManager.get("quest.main.heroes_alliance.decline", who);
    }
}