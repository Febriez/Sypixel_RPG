...
public class DragonPactQuest extends Quest {
     ...
     * 퀘스트 빌더
     */
    private static class DragonPactBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new DragonPactQuest(this);
        }
    }
     ...
     * 빌더 생성자
     */
    private DragonPactQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.dragon_pact.name");
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        ...
        return Component.translatable("quest.main.dragon_pact.objectives." + id);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.dragon-pact.dialogs.0");
            case 1 -> Component.translatable("quest.main.dragon-pact.dialogs.1");
            case 2 -> Component.translatable("quest.main.dragon-pact.dialogs.2");
            case 3 -> Component.translatable("quest.main.dragon-pact.dialogs.3");
            case 4 -> Component.translatable("quest.main.dragon-pact.dialogs.4");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.dragon-pact.npc-name");
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.dragon-pact.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.dragon-pact.decline");
    }
}