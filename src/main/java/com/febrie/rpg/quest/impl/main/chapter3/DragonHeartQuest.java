...
public class DragonHeartQuest extends Quest {
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return LangManager.get("quest.main.dragon_heart.name", who);
    }

    @Override
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        return LangManager.getList("quest.main.dragon_heart.info", who);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> LangManager.get("quest.main.dragon_heart.dialogs.0", who);
            case 1 -> LangManager.get("quest.main.dragon_heart.dialogs.1", who);
            case 2 -> LangManager.get("quest.main.dragon_heart.dialogs.2", who);
            case 3 -> LangManager.get("quest.main.dragon_heart.dialogs.3", who);
            case 4 -> LangManager.get("quest.main.dragon_heart.dialogs.4", who);
            case 5 -> LangManager.get("quest.main.dragon_heart.dialogs.5", who);
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return LangManager.get("quest.main.dragon_heart.npc_name", who);
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return LangManager.get("quest.main.dragon_heart.accept", who);
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return LangManager.get("quest.main.dragon_heart.decline", who);
    }
}