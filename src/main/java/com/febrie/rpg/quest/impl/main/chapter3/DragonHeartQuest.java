...
public class DragonHeartQuest extends Quest {
     ...
     * 퀘스트 빌더
     */
    private static class DragonHeartBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new DragonHeartQuest(this);
        }
    }
     ...
     * 빌더 생성자
     */
    private DragonHeartQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.dragon_heart.name");
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        ...
        return Component.translatable("quest.main.dragon_heart.objectives." + id);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.dragon-heart.dialogs.0");
            case 1 -> Component.translatable("quest.main.dragon-heart.dialogs.1");
            case 2 -> Component.translatable("quest.main.dragon-heart.dialogs.2");
            case 3 -> Component.translatable("quest.main.dragon-heart.dialogs.3");
            case 4 -> Component.translatable("quest.main.dragon-heart.dialogs.4");
            case 5 -> Component.translatable("quest.main.dragon-heart.dialogs.5");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.dragon-heart.npc-name");
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.dragon-heart.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.dragon-heart.decline");
    }
}