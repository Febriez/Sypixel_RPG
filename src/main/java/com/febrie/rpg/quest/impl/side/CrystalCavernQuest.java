...
public class CrystalCavernQuest extends Quest {
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_NAME, who);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_DIALOGS_0, who);
            case 1 -> LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_DIALOGS_1, who);
            case 2 -> LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_DIALOGS_2, who);
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_NPC_NAME, who);
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_ACCEPT, who);
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_SIDE_CRYSTAL_CAVERN_DECLINE, who);
    }
}