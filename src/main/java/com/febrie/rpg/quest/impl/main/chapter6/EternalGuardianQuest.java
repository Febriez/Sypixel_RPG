...
public class EternalGuardianQuest extends Quest {
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_NAME, who);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DIALOGS_0, who);
            case 1 -> LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DIALOGS_1, who);
            case 2 -> LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DIALOGS_2, who);
            case 3 -> LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DIALOGS_3, who);
            case 4 -> LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DIALOGS_4, who);
            case 5 -> LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DIALOGS_5, who);
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_NPC_NAME, who);
    }
    
    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_ACCEPT, who);
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return LangHelper.text(LangKey.QUEST_MAIN_ETERNAL_GUARDIAN_DECLINE, who);
    }
}