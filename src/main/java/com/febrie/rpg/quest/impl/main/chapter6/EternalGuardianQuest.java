...
public class EternalGuardianQuest extends Quest {
     ...
     * Quest builder
     */
    private static class EternalGuardianBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new EternalGuardianQuest(this);
        }
    }
     ...
     * Builder constructor
     */
    private EternalGuardianQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    private static QuestBuilder createBuilder() {
        return new EternalGuardianBuilder()
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.eternal-guardian.name");
    }
    ...
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        ...
        for (int i = 0; i < 3; i++) {
            description.add(Component.translatable("quest.main.eternal-guardian.description." + i));
        }
        return description;
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        return Component.translatable("quest.main.eternal-guardian.objectives." + objective.getId());
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.eternal-guardian.dialogs.0");
            case 1 -> Component.translatable("quest.main.eternal-guardian.dialogs.1");
            case 2 -> Component.translatable("quest.main.eternal-guardian.dialogs.2");
            case 3 -> Component.translatable("quest.main.eternal-guardian.dialogs.3");
            case 4 -> Component.translatable("quest.main.eternal-guardian.dialogs.4");
            case 5 -> Component.translatable("quest.main.eternal-guardian.dialogs.5");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.eternal-guardian.npc-name");
    }
    
    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.eternal-guardian.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.eternal-guardian.decline");
    }
}