...
public class RealmPortalQuest extends Quest {
     ...
     * 퀘스트 빌더
     */
    private static class RealmPortalBuilder extends QuestBuilder {
        @Override
        public Quest build() {
            return new RealmPortalQuest(this);
        }
    }
     ...
     * 빌더 생성자
     */
    private RealmPortalQuest(@NotNull QuestBuilder builder) {
        super(builder);
    }
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return Component.translatable("quest.main.realm_portal.name");
    }
    ...
    public @NotNull Component getObjectiveDescription(@NotNull QuestObjective objective, @NotNull Player who) {
        ...
        return Component.translatable("quest.main.realm_portal.objectives." + id);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> Component.translatable("quest.main.realm-portal.dialogs.0");
            case 1 -> Component.translatable("quest.main.realm-portal.dialogs.1");
            case 2 -> Component.translatable("quest.main.realm-portal.dialogs.2");
            case 3 -> Component.translatable("quest.main.realm-portal.dialogs.3");
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return Component.translatable("quest.main.realm-portal.npc-name");
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return Component.translatable("quest.main.realm-portal.accept");
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return Component.translatable("quest.main.realm-portal.decline");
    }
}