...
public class RealmPortalQuest extends Quest {
    ...
    public @NotNull Component getDisplayName(@NotNull Player who) {
        return LangManager.get("quest.main.realm_portal.name", who);
    }

    @Override
    public @NotNull List<Component> getDisplayInfo(@NotNull Player who) {
        return LangManager.getList("quest.main.realm_portal.info", who);
    }
    ...
    public Component getDialog(int index, @NotNull Player who) {
        return switch (index) {
            case 0 -> LangManager.get("quest.main.realm_portal.dialogs.0", who);
            case 1 -> LangManager.get("quest.main.realm_portal.dialogs.1", who);
            case 2 -> LangManager.get("quest.main.realm_portal.dialogs.2", who);
            case 3 -> LangManager.get("quest.main.realm_portal.dialogs.3", who);
            default -> null;
        };
    }
    ...
    public @NotNull Component getNPCName(@NotNull Player who) {
        return LangManager.get("quest.main.realm_portal.npc_name", who);
    }

    @Override
    public @NotNull Component getAcceptDialog(@NotNull Player who) {
        return LangManager.get("quest.main.realm_portal.accept", who);
    }
    
    @Override
    public @NotNull Component getDeclineDialog(@NotNull Player who) {
        return LangManager.get("quest.main.realm_portal.decline", who);
    }
}