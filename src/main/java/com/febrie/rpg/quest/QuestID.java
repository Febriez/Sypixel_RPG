...
public enum QuestID {
    ...
    // ===== 반복 퀘스트 (Repeatable) =====
    REPEATABLE_MONSTER_EXTERMINATION(QuestCategory.REPEATABLE),
    REPEATABLE_RESOURCE_COLLECTION(QuestCategory.REPEATABLE),
    REPEATABLE_EQUIPMENT_UPGRADE(QuestCategory.REPEATABLE),
    ...
    // ===== 탐험 퀘스트 (Exploration) =====
    EXPLORE_ANCIENT_RUINS(QuestCategory.EXPLORATION),
