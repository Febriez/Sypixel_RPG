...
public class StandardItemBuilder {
     ...
     */
    @NotNull
    public static ItemBuilder guiItem(@NotNull Material material, @NotNull String name, @NotNull String... lore) {
    ...
    public static ItemBuilder nextPageButton(int currentPage) {
        return guiItem(Material.ARROW, "&f다음 페이지", 
            "&7현재 페이지: &e" + currentPage,
            "&7클릭하여 다음 페이지로 이동");
    }
    ...
    public static ItemBuilder previousPageButton(int currentPage) {
        return guiItem(Material.ARROW, "&f이전 페이지",
            "&7현재 페이지: &e" + currentPage,
            "&7클릭하여 이전 페이지로 이동");
    }
